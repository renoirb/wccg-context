/**
 * @fileoverview Context Root to gather unsatisfied context requests (exact copy)
 * @author Google LLC
 * @license BSD-3-Clause
 * @source Unmodified copy from @lit/context@1.1.6
 * @see https://github.com/lit/lit/blob/43c6168a/packages/context/src/lib/context-root.ts
 */
