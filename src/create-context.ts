/**
 * @fileoverview Create Context (modifications: createContext explicit typing)
 * @author Google LLC
 * @license BSD-3-Clause
 * @source Copy of @lit/context@1.1.6
 * @see https://github.com/lit/lit/blob/%40lit/context%401.1.6/packages/context/src/lib/create-context.ts#L7-L56
 */
 ...
 */
export function createContext<ValueType, K = unknown>(key: K): Context<K, ValueType> {
